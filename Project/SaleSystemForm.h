...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox2->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &SaleSystemForm::textBox2_KeyDown);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &SaleSystemForm::button1_Click);
			// 
			// SaleSystemForm
			// 
